...
const Taskdetails = () => {
  ...
  return (
    <body className="bg-[#000] pb-[50px] md:pb-[100px] min-h-[100svh]">
      <div>
        ...
        {/* content */}
        <div className="px-[16px] md:mx-auto md:w-[60%] lg:w-[60%]">
          <div className="clashmd pt-[100px] md:pt-[140px] mb-[26px] md:mb-[40px] text-[24px] text-left md:text-left mx-0 md:mx-0 font-[500] tracking-[0.34px] md:text-[34px] text-[#fff]">
            Task details
          </div>
          {/* forms */}
          <div className="w-full mb-[28px]">
            <div className="input_label md:tracking-[0.32px] tracking-[0.3px] mb-[6px] leading-[140%] clashlt font-[400]">
              Your target Platform
            </div>
            <input
              type="text"
              className="py-[10px] capitalize input_label bg-[transparent] clashlt tracking-[0.3px] leading-[160%] font-[400] px-[22px] border border-[#4c4c4c] rounded-[10px] w-full focus:outline-none"
            />
          </div>
          {/* ----- */}
          <div className="w-full mb-[28px]">
          ...
          <div className="w-full mb-[28px]">
            ...
            <div className="py-[10px] h-[247.1px] md:h-[226px] capitalize input_label bg-[transparent] clashlt tracking-[0.3px] leading-[160%] font-[400] px-[22px] border border-[#4c4c4c] rounded-[10px] w-full focus:outline-none"></div>
          </div>
          {/* --- */}
          {/* ----- */}
          <div className="w-full mb-[28px]">
            ...
            <div className="py-[10px] h-fit capitalize input_label bg-[transparent] clashlt tracking-[0.3px] leading-[160%] font-[400] px-[22px] border border-[#4c4c4c] rounded-[10px] w-full focus:outline-none">
              {""}
            </div>
          </div>
          {/* --- */}
          ...
          <div className="w-full mb-[28px]">
            ...
            <div className="py-[10px] space-y-[8px] space-x-[10px] flex flex-wrap item-center h-fit capitalize input_label bg-[transparent] clashlt tracking-[0.3px] leading-[160%] font-[400] px-[22px] border border-[#4c4c4c] rounded-[10px] w-full focus:outline-none">
              {""}
            </div>
          </div>
          {/* --- */}
