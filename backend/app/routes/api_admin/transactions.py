...
@bp.route('/user_credit_transactions/<user_id>', methods=['POST'])
@roles_required('Junior Admin')
...
@bp.route('/user_debit_transactions/<user_id>', methods=['POST'])
@roles_required('Junior Admin')
...
@bp.route('/user_payment_transactions/<user_id>', methods=['POST'])
@roles_required('Junior Admin')
...
@bp.route('/user_withdrawal_transactions/<user_id>', methods=['POST'])
@roles_required('Junior Admin')
