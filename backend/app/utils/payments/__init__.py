...
from ...models import Payment, Transaction, TransactionType, Trendit3User
from ...utils.helpers.basic_helpers import console_log, log_exception, generate_random_string
from ...utils.helpers.mail_helpers import send_other_emails

def credit_user_wallet(user_id: int, amount: int | float | Decimal):
...
def debit_user_wallet(user_id: int, amount: int | float | Decimal, payment_type=None):
    user = Trendit3User.query.get(user_id)
